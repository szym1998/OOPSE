            ...
            int start_battle(int player_ID) {
                ...
                while (true) {
                    ...
                    if(var > 0)
                    {
                        ...
                        std::string str = ("/home/imirgrp/bogdani/lab1/vending_machine/Lab12/cmake-build-debug/Enemie_storage/" + monster_ID + ".csv");
                        const char *cstr = str.c_str();
                        std::string str2 = ("/home/imirgrp/bogdani/lab1/vending_machine/Lab12/cmake-build-debug/Character_storage/" + std::to_string(player_ID) + ".csv");
