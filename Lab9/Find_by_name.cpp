...
std::vector <int> list_f(int opt)
{
    ...
    {
        case 0:
            di = opendir("/home/imirgrp/bogdani/lab1/vending_machine/Lab9/cmake-build-debug/Character_storage");
            break;
        case 1:
            di = opendir("/home/imirgrp/bogdani/lab1/vending_machine/Lab9/cmake-build-debug/Enemie_storage");
            break;
    }
