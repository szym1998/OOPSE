...
/*Monsters::Monsters(int a0, std::string a1, std::string a2, int b1, int b2, int b3, int b4, int b5)
{
    type = a1;
    name = a2;
    level = b1;
...
void Character_variables::Save(int opt){
    ...
    {
        case 0:
            path = "/home/imirgrp/bogdani/lab1/vending_machine/Lab10/cmake-build-debug/Character_storage/";
            break;
        case 1:
            path = "/home/imirgrp/bogdani/lab1/vending_machine/Lab10/cmake-build-debug/Enemie_storage/";
            break;
    }
